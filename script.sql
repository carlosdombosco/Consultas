...
CON_DATA DATE,
CON_HORA TIME,
CON_PROTOCOLO VARCHAR(20),
CON_EXA_CODIGO_FK INT
...
CONSTRAINT FK_EXAME_CONSULTA FOREIGN KEY (CON_EXA_CODIGO_FK) REFERENCES EXAME (EXA_CODIGO_PK)
ON UPDATE CASCADE
ON DELETE CASCADE
)
...
INSERT INTO USUARIO (USU_EMAIL, USU_NOME, USU_SENHA) VALUES ('teste@uol.com.br', 'Intelectah', '123')
